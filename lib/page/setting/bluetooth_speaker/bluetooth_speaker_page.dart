...
class BluetoothSpeakerPage extends StatefulWidget {
  const BluetoothSpeakerPage({Key key, this.title, this.device}) : super(key: key);

  final String title;
  final BluetoothDevice device;

  @override
  _BluetoothSpeakerPageState createState() => _BluetoothSpeakerPageState();
}

class _BluetoothSpeakerPageState extends State<BluetoothSpeakerPage> {
  // flutterBlue
